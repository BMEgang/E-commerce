...
public class OrderServlet extends BaseServlet {
    public String saveOrder(HttpServletRequest req, HttpServletResponse resp) throws SQLException {
        //确认是否登陆
        User user = (User) req.getSession().getAttribute("loginUser");
        if (null == user){
            req.setAttribute("msg","please order after login");
            return "/jsp/info.jsp";
        }
    ...
    public String findMyOrdersWithPage(HttpServletRequest req, HttpServletResponse resp) throws SQLException, InvocationTargetException, IllegalAccessException {
        User user = (User) req.getSession().getAttribute("loginUser");
    ...
    public String findOrderByOid(HttpServletRequest req, HttpServletResponse resp) throws SQLException, InvocationTargetException, IllegalAccessException {
    ...
    public String callBack(HttpServletRequest request, HttpServletResponse resp) throws Exception {
        ...
        if (isValid) {
            ...
            if (r9_BType.equals("1")) {
                ...
                //如果支付成功,更新订单状态
                OrderService orderService=new OrderServiceImp();
                Order order=orderService.findOrdersByOid(r6_Order);
                order.setState(2);
                orderService.updateOrder(order);
                //向request放入提示信息
