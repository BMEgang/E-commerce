...
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		<font>user register</font>USER REGISTER
		<form class="form-horizontal" style="margin-top:5px;" action="${pageContext.request.contextPath}/UserServlet?method=userRegist" method="post">
			 <div class="form-group">
			   ...
			   <div class="form-group">
			    <label for="confirmpwd" class="col-sm-2 control-label">confirm pwd</label>
			    <div class="col-sm-6">
			 ...
			 <div class="form-group">
			  ...
			  <label for="inlineRadio1" class="col-sm-2 control-label">sex</label>
			  <div class="col-sm-6">
			...
			<label class="radio-inline">
			  ...
			  <div class="form-group">
				...
				<div class="form-group">
					<label for="date" class="col-sm-2 control-label">telephone</label>
					<div class="col-sm-6">
			  ...
			  <div class="form-group">
			    <label for="date" class="col-sm-2 control-label">auth code</label>
			    <div class="col-sm-3">
