...
<div class="container"  style="width:100%;height:460px;background:#FF2C4C url('${pageContext.request.contextPath}/img/back.jpg') no-repeat;">
<div class="row"> 
	<div class="col-md-7">
	...
	<div class="col-md-5">
				...
				<font>user login</font>USER LOGIN
...
<form class="form-horizontal" action="${pageContext.request.contextPath}/UserServlet?method=userLogin" method="post">
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="submit"  width="100" value="change pwd" name="changepwd" border="0"
    style="background: url('${pageContext.request.contextPath}/img/login.gif') no-repeat scroll 0 0 rgba(0, 0, 0, 0);
    height:35px;width:100px;color:white;">
    </div>
  </div>
